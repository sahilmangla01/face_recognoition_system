...
class Login_Window:
    def __init__(self,root):
        ...
        title=Label(bg_lbl,text="BIOMETRIC ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="red")
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            conn=mysql.connector.connect(host="localhost",user="root",password="@#Sahil123456",database="face_recognizor")
